...
${API_SEARCH_URL}     https://dev.onepay.vn/iportal/api/v1/qr/purchase-search
${API_DETAIL_URL}    http://127.0.0.1/iportal/api/v1/qr/purchase-search/
${COOKIE}            auth=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..D68OjMUGB8HC03V0BzDuKqzv3kJaA3aB8NQwK7VGscU; Max-Age=14400; Expires=Wed, 07 Jun 2023 06:41:28 GMT; Path=/iportal; HTTPOnly
*** Test Cases ***
