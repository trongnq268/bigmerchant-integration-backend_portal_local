        ...
        for key in keyValueExpects:
            if key != "" and key is not None:
                for tran in transactions:
                    if valueExpect[key] != tran[key]:
                        flgCheck = False
                        listObjectFail.append(
                            tran["transaction_id"] + "-" + tran[key] + "-" + valueExpect[key])
...
def check_response_transactionID(responseBody, valueExpect):
    flgCheck = True
    listObjectFail = []
    if is_json(responseBody) != True:
        flgCheck = False
    ...
    if "transactions" in body:
        ...
        for key in keyValueExpects:
            if key != "" and key is not None:
                for tran in transactions:
                    if valueExpect["transaction_id"] != tran["transaction_id"] and valueExpect["transaction_id"] != tran["original_id"]:
                        flgCheck = False
                        listObjectFail.append(
                            tran["transaction_id"] + "-" + tran[key] + "-" + valueExpect[key])
    else:
...
def checkResponseBankID(responseBody, valueExpect):
    flgCheck = True
    listObjectFail = []
    if is_json(responseBody) != True:
        flgCheck = False
    ...
    if "transactions" in body:
        ...
        for tran in transactions:
            if valueExpect["acquirer_id"].find(str(tran["acquirer"]["acquirer_id"])) == -1:
                flgCheck = False
                listObjectFail.append(
                    tran["transaction_id"] + "-" + tran["acquirer"]["acquirer_id"] + "-" + valueExpect["acquirer_id"])
    else:
        flgCheck = False
        listObjectFail.append("DATA NOT FOUND")
    return flgCheck, listObjectFail

def checkResponseCardNumber(responseBody, valueExpect):
    flgCheck = True
    listObjectFail = []
    if is_json(responseBody) != True:
        flgCheck = False
    ...
    if "transactions" in body:
        ...
        for tran in transactions:
            if valueExpect["card_number"].find(str(tran["card"]["card_number"])) == -1:
                flgCheck = False
                listObjectFail.append(
                    tran["transaction_id"] + "-" + tran["card"]["card_number"] + "-" + valueExpect["card_number"])
    else:
        flgCheck = False
        listObjectFail.append("DATA NOT FOUND")
    return flgCheck, listObjectFail
